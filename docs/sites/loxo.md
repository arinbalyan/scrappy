...
- Extracted fields: title, description, location, compensation, employment type
...
- ATS scraper. Uses ats.ResolveSeeds via SCRAPPY_LOXO_SEEDS or config/company_slugs.yaml or search term as slug. The search term IS the company slug.
