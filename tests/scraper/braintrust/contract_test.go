...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/braintrust"
)

func TestBraintrustFailsOnEmptyResponse(t *testing.T) {
...
func TestBraintrustFailsOn429And503(t *testing.T) {
