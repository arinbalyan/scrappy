...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/remoteok"
)

func TestRemoteokFailsOnEmptyResponse(t *testing.T) {
...
func TestRemoteokFailsOn429And503(t *testing.T) {
