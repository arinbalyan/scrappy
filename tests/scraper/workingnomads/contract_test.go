...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/workingnomads"
)

func TestWorkingnomadsFailsOnEmptyResponse(t *testing.T) {
...
func TestWorkingnomadsFailsOn429And503(t *testing.T) {
