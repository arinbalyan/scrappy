...
func TestWeworkremotelyParsesRSS(t *testing.T) {
	rss := `<?xml version="1.0"?><rss><channel><item><title><![CDATA[Acme: Senior Go Engineer]]></title><link>https://weworkremotely.com/remote-jobs/acme-senior-go-engineer</link><description><![CDATA[<p>Build APIs</p>]]></description><pubDate>Mon, 20 May 2026 12:00:00 +0000</pubDate><region>Remote</region><country>Anywhere</country><state></state><skills>Go,Backend</skills><type>Full Time</type></item></channel></rss>`
...
func TestWeworkremotelyFailsOn429And503(t *testing.T) {
