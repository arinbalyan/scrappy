...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/remoteco"
)

func TestRemotecoFailsOnEmptyResponse(t *testing.T) {
...
func TestRemotecoFailsOn429And503(t *testing.T) {
