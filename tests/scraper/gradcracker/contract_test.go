...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/gradcracker"
)

func TestGradcrackerFailsOnEmptyResponse(t *testing.T) {
...
func TestGradcrackerFailsOn429And503(t *testing.T) {
