...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/hiringcafe"
)

func TestHiringcafeFailsOnEmptyResponse(t *testing.T) {
...
func TestHiringcafeFailsOn429And503(t *testing.T) {
