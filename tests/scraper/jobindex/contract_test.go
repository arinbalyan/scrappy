...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/jobindex"
)

func TestJobindexFailsOnEmptyResponse(t *testing.T) {
...
func TestJobindexFailsOn429And503(t *testing.T) {
