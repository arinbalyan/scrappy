...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/ukvisajobs"
)

func TestUkvisajobsFailsOnEmptyResponse(t *testing.T) {
...
func TestUkvisajobsFailsOn429And503(t *testing.T) {
