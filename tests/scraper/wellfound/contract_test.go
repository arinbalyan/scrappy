...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/wellfound"
)

func TestWellfoundFailsOnEmptyResponse(t *testing.T) {
...
func TestWellfoundFailsOn429And503(t *testing.T) {
