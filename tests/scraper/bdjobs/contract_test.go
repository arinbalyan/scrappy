...
func TestBDJobsParsesListings(t *testing.T) {
	html := `<div class="job-item"><a href="jobdetail.asp?jobid=123"><strong>Software Engineer</strong></a><div class="comp-name">Acme</div><div class="location">Dhaka</div></div>`
	...
	defer cancel()
	jobs, err := s.Scrape(ctx, model.ScraperInput{SearchTerm: "software", ResultsWanted: 1})
