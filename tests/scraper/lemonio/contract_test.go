...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/lemonio"
)

func TestLemonioFailsOnEmptyResponse(t *testing.T) {
...
func TestLemonioFailsOn429And503(t *testing.T) {
