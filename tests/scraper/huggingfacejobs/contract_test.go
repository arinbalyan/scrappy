...
import (
	...
	sut "github.com/arinbalyan/scrappy/internal/scraper/huggingfacejobs"
)

func TestHuggingfacejobsFailsOnEmptyResponse(t *testing.T) {
...
func TestHuggingfacejobsFailsOn429And503(t *testing.T) {
